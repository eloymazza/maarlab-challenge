		...
		<CardContainer>
			...
			<InfoContainer>
				<div>
					...
					<Distance>{hotel.coordinates.latitude.toFixed(2)} km from location</Distance>
					<PriceContainer>
						<FinalPrice>${hotel.finalPrice} pp</FinalPrice>
						{hotel.finalPrice < hotel.originalPrice && <OriginalPrice>${hotel.originalPrice} pp</OriginalPrice>}
					</PriceContainer>
				</div>
				<FeaturesContainer>
